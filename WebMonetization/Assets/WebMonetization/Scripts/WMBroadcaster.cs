...
public class WMBroadcaster : MonoBehaviour
{
    ...
    public delegate void MonetizationStopAction(Dictionary<string, object> detail);
    public static event MonetizationStopAction OnMonetizationStop;
    ...
    public void monetizationstop(String detailJson)
    {
        var detail = wm_MiniJSON.Json.Deserialize(detailJson) as Dictionary<string, object>;
        OnMonetizationStop?.Invoke(detail);
    }
